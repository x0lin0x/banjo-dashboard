...
- `GET /stats/overview?window=24h|7d|30d` (includes active positions count, balance/ATH/DD, R-metrics by closed position, win-rate long/short, avg holding time, exit distribution exact/proxy depending on data)
